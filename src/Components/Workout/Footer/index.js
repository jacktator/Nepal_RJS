...
const contentOfTabs = (props) => [
  { title: selectedDiv('history', props), value: 'history' },
  { title: selectedDiv('plan', props), value: 'plan' },
  { title: selectedDiv('workout', props), value: 'workout' },
  { title: selectedDiv('me', props), value: 'me' },
]
  ...
  <div className='container'>
    <div className="footer-container">
      <Tabs
        ...
        style={{ height: '1000px' }}
        tabs={contentOfTabs(props.currentPage)}
        swipeable={false}
